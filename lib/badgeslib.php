...
/**
 * Prepare badgeclass for external
 * @param core_badges\output\badgeclass $badgeclass
 * @return object
 */
function badges_prepare_badgeclass_for_external(core_badges\output\badgeclass $badgeclass): object {
    global $PAGE;
    ...
    $image = \moodle_url::make_webservice_pluginfile_url(
