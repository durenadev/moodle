...
if ($hassiteconfig || has_capability('moodle/site:configview', context_system::instance())) {
    ...
    $mobileappsubscriptionstr = (string) new lang_string('mobileappsubscription', 'tool_mobile');
    ...
    if (!$ispremiumplan) {
        $mobileappsubscriptionstr .= ' 🚀 ' . strtoupper(get_string('upgradeyourplan', 'tool_mobile'));
    }
    ...
    $premiumfeaturesstr = get_string('premiumfeatures', 'tool_mobile');
    ...
    $temp->add(new admin_setting_heading(
        ...
        new lang_string('authentication', 'tool_mobile'),
        ''
    ));
    ...
    $temp->add(new admin_setting_heading(
        'tool_mobile/customization',
        new lang_string('customization', 'tool_mobile'),
        ''
    ));
