...
$string['limitedcustomlangstrings'] = 'Total number of custom language strings in your <strong>{$a->plan}</strong> plan: {$a->limit}. <a href="{$a->url}">View plan details</a>.';
$string['limiteddisabledfeatures'] = 'Total number of disabled features in your <strong>{$a->plan}</strong> plan: {$a->limit}. <a href="{$a->url}">View plan details</a>.';
