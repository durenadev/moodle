...
$string['nosubscouldntretrive'] = "We couldn't retrieve your plan details";
...
$string['showingcacheddata'] = 'Subscription last checked, 10 days ago. To access more detailed data, please log in to the <a href="{$a}" target="_blank">Moodle Apps Portal</a>.';
