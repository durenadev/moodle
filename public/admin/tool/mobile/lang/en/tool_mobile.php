...
$string['learnmoreplan'] = 'To learn more about the Moodle app and its plans, see the <a href="{$a->url}">Moodle app plans documentation</a>.';
...
$string['messagegreeting'] = 'You are receiving this notification because you are administrator of {$a}.';
